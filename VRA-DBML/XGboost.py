...
def train_xgboost(train_csv, model_path='xgb_volatility_model.pkl', scaler_path='xgb_scaler.pkl'):
 ...
 # Reduce weightage of 'v' in input features
    ...
    joblib.dump(vol_threshold, 'xgb_volatility_threshold.pkl')

    return model, scaler, vol_threshold

def test_xgboost(test_csv, model_path='xgb_volatility_model.pkl', scaler_path='xgb_scaler.pkl', threshold_path='xgb_volatility_threshold.pkl', output_csv='xgb_volatility_predictions.csv'):
...
if __name__ == "__main__":
    # Train
    train_xgboost('train.csv')
    # Test
    test_xgboost('valtest.csv')