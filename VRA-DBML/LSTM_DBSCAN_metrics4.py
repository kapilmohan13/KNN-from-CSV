...
# --- CONFIGURATION ---
merged_file = 'merged_DBSCAN_LSTM.csv'
output_txt = 'LSTM_DBSCAN_prediction.txt'

# --- LOAD MERGED DATA ---
df = pd.read_csv(merged_file)

# --- HARD VOTING STRATEGY ---
# Combine 'predicted_volatility_risk' and 'risk' (DBSCAN) by hard voting
# If both agree, use that label; if disagree, use 'high' if either is 'high', else 'low'
def hard_vote(row):
