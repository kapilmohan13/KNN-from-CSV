...
# --- CONFIGURATION ---
rf_file = 'rf_volatility_predictions.csv'
dbscan_file = 'risk_assessment_results.csv'
output_csv = 'merged_DBSCAN_RF.csv'
output_txt = 'RF_metrics_ML.txt'
...
# --- MERGE ---
if 'timestamp' in rf_df.columns and 'timestamp' in dbscan_df.columns:
    merged_df = pd.merge(rf_df, dbscan_df[['timestamp', 'cluster', 'risk']], on='timestamp', how='left')
else:
    merged_df = rf_df.copy()
