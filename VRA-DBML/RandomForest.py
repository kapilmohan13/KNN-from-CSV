...
def train_random_forest(train_csv, model_path='rf_volatility_model.pkl', scaler_path='rf_scaler.pkl'):
    ...
    joblib.dump(vol_threshold, 'rf_volatility_threshold.pkl')

    return model, scaler, vol_threshold

def test_random_forest(test_csv, model_path='rf_volatility_model.pkl', scaler_path='rf_scaler.pkl', threshold_path='rf_volatility_threshold.pkl', output_csv='rf_volatility_predictions.csv'):
...
if __name__ == "__main__":
    # Train
    train_random_forest('train.csv')
    # Test
    test_random_forest('valtest.csv')