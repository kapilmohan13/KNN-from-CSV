...
# --- CONFIGURATION ---
svm_file = 'svm_volatility_predictions.csv'
dbscan_file = 'risk_assessment_results.csv'
output_csv = 'merged_DBSCAN_SVM.csv'
output_txt = 'SVM_metrics_ML.txt'
...
# --- MERGE ---
if 'timestamp' in svm_df.columns and 'timestamp' in dbscan_df.columns:
    merged_df = pd.merge(svm_df, dbscan_df[['timestamp', 'cluster', 'risk']], on='timestamp', how='left')
else:
    merged_df = svm_df.copy()
